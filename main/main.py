        ...
        try:
            ...
            while running:
                ...
                if self.current_state == "start_screen":
                    ...
                    if result:
                        self.current_state = "rules_page"

                elif self.current_state == "rules_page":
                    self.rules_page=rules(self.screen)
                    level_result=self.rules_page.run_level()
                    ...
                    font = pygame.font.Font('Resources\text\Chakra_Petch\ChakraPetch-Light.ttf', 36)
            ...
            font = pygame.font.Font("Resources\text\Chakra_Petch\ChakraPetch-Light.ttf", 20)
